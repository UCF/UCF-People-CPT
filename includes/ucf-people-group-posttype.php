<?php
/**
 * Handles the registration of the group custom post type and taxonomies.
 * @author Jim Barnes
 * @since 1.0.0
 **/
if ( ! class_exists( 'UCF_People_Group_PostType' ) ) {
	class UCF_People_Group_PostType {
		/**
		 * Registers the Group custom post type.
		 * @author Jim Barnes
		 * @since 1.0.0
		...
		public static function register() {
			$singular = apply_filters( 'ucf_people_group_singular_label', 'People Group' );
			$plural = apply_filters( 'ucf_people_group_plural_label', 'People Groups' );
			register_post_type( 'people_group', self::args( $singular, $plural ) );
		}
		...
		public static function args( $singular, $plural ) {
			...
			$args = apply_filters( 'ucf_people_group_post_type_args', $args );
		...
		public static function taxonomies() {
			...
			$taxonomies = apply_filters( 'ucf_people_group_taxonomies', $taxonomies );
